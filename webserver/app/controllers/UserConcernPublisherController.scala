...
class UserConcernPublisherController @Inject() (val userConcernPublisherService: UserConcernPublisherService, val userService: UserService)(implicit ec: ExecutionContext)
  ...
  def addConcernPublisher(uid: Long, pname: String) = AsyncStack(AuthorityKey -> RegistRole) { implicit request =>
  ...
  def remConcernPublisher(uid: Long, pname: String) = AsyncStack(AuthorityKey -> RegistRole) { implicit request =>
  ...
  def listConcernPublisher(uid: Long, page: Long, count: Long) = AsyncStack(AuthorityKey -> RegistRole) { implicit request =>
  ...
  def loadNewsByConcernedPublishers(uid: Long, page: Long, count: Long, tcursor: Long) = AsyncStack(AuthorityKey -> RegistRole) { implicit request =>
  ...
  def refreshNewsByConcernedPublishers(uid: Long, page: Long, count: Long, tcursor: Long) = AsyncStack(AuthorityKey -> RegistRole) { implicit request =>
